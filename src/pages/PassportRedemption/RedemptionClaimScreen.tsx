...
const PassportRedemptionClaim = ({ setCurrentScreenView }: Props) => {
    ...
    const markAsDone = () => {
        // TODO(Olivia): dispatch some action to state
    ...
    return (
        <Container>
            ...
            <Margin>
                <FinePrint className='center bold red'>Please show this screen to the host when you are placing your order.</FinePrint>
                <Button
