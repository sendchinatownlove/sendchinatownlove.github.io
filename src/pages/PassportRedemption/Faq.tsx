...
const Faq = () => {
    return (
        <Container>
            <PassportContainer className="faq">
              <TopContainer>
                <ExternalLink className="faq" href="">VIEW MAP</ExternalLink>
                <Logo
                  src={CircleLogo}
                  alt="scl-log" />
                <ExternalLink className="faq" href="mailto:hello@sendchinatownlove.com">CONTACT US</ExternalLink>
              </TopContainer>
              <FaqContainer>
                <HeaderContainer >
                ...
                <Question>8. How many tickets do I need to win a reward?</Question>
                  ...
                  <BulletPoint>Every three (3) tickets qualifies you for one (1) local reward. You can get as many tickets as you want, as long as your three (3) tickets are from different vendors. 
                    <ul>
                      <BulletPoint>
