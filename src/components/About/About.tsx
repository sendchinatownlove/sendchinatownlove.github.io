      ...
      <main className={styles.container}>
        <div className={styles.introContainer}>
          ...
          <div className={styles.introTextSection}>
            <p className={styles.introText}>Once a bustling location known for its delicious food, fresh produce, and affordable prices – NYC’s Chinatown has now become completely barren. Although many businesses have been affected by the recent COVID-19 outbreak, Chinatown has had it the worst. Chinatown businesses have been facing declines in business due to discrimination and racism weeks before other restuarants felt similar effects of COVID-19 on sales. Immigrant owners who typically don’t speak English and their dependence on a cash-only system have put them at an even greater disadvantage of surviving through this pandemic.</p>
            <p className={styles.introText}>They were there for you on those late 4am nights you barely remember, or the next morning when you were desperately seeking a fresh bowl of noodle soup and cold tea. To all the tourists and locals alike who have visited NYC’s Chinatown and were mesmerized by the ambience and enjoyed it’s services. Be there for your Chinatown. The time to help is now.</p>
          </div>
          <a href="mailto:sendchinatownlove@gmail.com">
            <button className={styles.ctaButton}>Partner with us</button>
          </a>
          <span className={styles.ctaSubtext}>We partner with local businesses</span>
        </div>
      </main>
      <Footer />
    </div>
